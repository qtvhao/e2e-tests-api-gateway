 ...
 *
 * Related tests found: e2e/tests/system-integration/api-gateway/handlers/navigation.spec.ts
...
- e2e/tests/system-integration/api-gateway/ui/login/login-form.ui.spec.ts
- e2e/tests/system-integration/api-gateway/routes/frontend-catchall.spec.ts
...
- e2e/tests/system-integration/api-gateway/ui/login/login-form.api.spec.ts
- e2e/tests/system-integration/api-gateway/ui/login/login-form.validation.spec.ts
