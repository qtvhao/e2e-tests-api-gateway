/**
 * @fileoverview Authelia E2E Tests - Main Entry Point
 ...
 * Comprehensive test suite for Authelia API endpoints and UI interactions.
 *
 * Tests are organized into focused, modular test files covering:
 *
 * 1. Authelia.api.spec.ts
