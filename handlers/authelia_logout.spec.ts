/**
 * @fileoverview Authelia Logout E2E Tests - Main Entry Point
 ...
 * Comprehensive test suite for Authelia Logout API endpoints and UI interactions.
 *
 * Tests are organized into focused, modular test files covering:
 *
 * 1. Authelia Logout.api.spec.ts
 ...
 *
 * 3. Authelia Logout.errors.spec.ts
