/**
 * @fileoverview Dashboard E2E Tests - Main Entry Point
 ...
 * Comprehensive test suite for Dashboard API endpoints and UI interactions.
 *
 * Tests are organized into focused, modular test files covering:
 *
 * 1. Dashboard.api.spec.ts
